...
var TemplateKey;
(function(TemplateKey9) {
  TemplateKey9["movieTemplateFile"] = "movieTemplateFile";
  TemplateKey9["bookTemplateFile"] = "bookTemplateFile";
  TemplateKey9["musicTemplateFile"] = "musicTemplateFile";
  TemplateKey9["noteTemplateFile"] = "noteTemplateFile";
  TemplateKey9["gameTemplateFile"] = "gameTemplateFile";
  TemplateKey9["teleplayTemplateFile"] = "teleplayTemplateFile";
...
var DoubanTheaterLoadHandler = class extends DoubanAbstractLoadHandler {
  ...
  parseSubjectFromHtml(html3, context) {
    ...
    publish.map((index2, info) => {
      ...
      valueMap.set(MovieKeyValueMap2.get(key), value);
    });
    movie.country = valueMap.has("country") ? valueMap.get("country") : [];
    movie.language = valueMap.has("language") ? valueMap.get("language") : [];
    movie.time = valueMap.has("time") ? valueMap.get("time") : "";
